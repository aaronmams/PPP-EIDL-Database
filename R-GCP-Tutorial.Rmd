...
This section is organized around two questions I imagine you might have for me:

Q1. why would one want to do this?
...
```{r, echo=FALSE, out.width="200%", fig.cap="A nice image."}
library(here)
knitr::include_graphics(here('Entity-Relationship-Diagram.png'))
```
